/*
    'livingRoomAlcoveLight1_Mesh' by Thurstan.
...
/*----------------------------system--------------------------*/
const String _progName = "livingRoomAlcoveLight1_Mesh";
const String _progVers = "0.100";                 // Init
...
/*----------------------------LED-----------------------------*/
const uint16_t _ledNum = 30;                      // NeoPixelBus - 30 LEDs - approx. 1.5A
...
unsigned long _ledRiseSpeed = 25;                 // speed at which the LEDs turn on
